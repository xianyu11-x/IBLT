...
CUSTOM_CONF_FILE="$SDE/$(find -type f -path "*p4-examples*/ptf-tests")/$P4_NAME/custom_conf_file"
if [ ! -f $CUSTOM_CONF_FILE ]; then
    CUSTOM_CONF_FILE="$SDE/$(find -type d -path "*p4-examples*/p4_16_programs")/$P4_NAME/custom_conf_file"
fi
