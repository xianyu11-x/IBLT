...
default_with_thrift="--enable-thrift --auto-init-metadata"   # Build Thrift Client/Server Code
                                        # (p4_14 only)
...
default_p4flags_p4_14="-g --verbose 2 --parser-timing-reports --display-power-budget --disable-power-check --auto-init-metadata" 
#default_p4flags_p4_16="-g --verbose 2 --parser-timing-reports --display-power-budget --disable-power-check --auto-init-metadata"
default_p4flags_p4_16="-g --verbose 2 --parser-timing-reports --display-power-budget --auto-init-metadata"
...
EOF
    ...
    cmd="$SDE_PKGSRC/${p4_build}/configure        \
           ...
           P4JOBS=$P4JOBS                         \
           P4FLAGS=\"$P4FLAGS --auto-init-metadata\"                   \
...
opts=`getopt -o hvj:pI:D:U:                                         \
             ...
             -l p4flags-override  -l auto-init-metadata             \
             -- "$@"`
